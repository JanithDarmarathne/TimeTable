...
public class addGroup extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel12Layout.setVerticalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(select_gId, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(select_day, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE))
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txt_time_to, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE))
                .addGap(10, 10, 10)
        ...
        if (tbl_gId.getColumnModel().getColumnCount() > 0) {
            ...
            tbl_gId.getColumnModel().getColumn(2).setResizable(false);
            tbl_gId.getColumnModel().getColumn(3).setResizable(false);
        }
    ...
    private void btn_updategIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updategIdActionPerformed
        ...
        try
        {
            ...
            if(txt_id.getText().equals("")){
                ...
                if(select_gId.getSelectedItem().equals("Select") && 
                ...
                txt_error.setText("Enter Deatils*");
                    ...
                    smt.execute("UPDATE sp2_group_wise SET gId = '"+select_gId.getSelectedItem().toString()+"',"
    ...
    private void btn_addgIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addgIdActionPerformed
        ...
        try{
            ...
            if(select_gId.getSelectedItem().equals("Select") && 
                ...
                PreparedStatement statement = connection.prepareStatement(CreateQuery.getQuery(Constant.INSERT_SP2_GROUP_WISE_TABLE));
                statement.setString(1, select_gId.getSelectedItem().toString());
    ...
    public ArrayList<GroupId> GetGroupIdList()
    {
        ArrayList<GroupId> list = new ArrayList<GroupId>();
        try{
        connection = DBconnection.getConnection();
        String querry = "select * from sp2_group_wise";
        Statement st;
        ResultSet rs;
        ...
        while(rs.next())
        {
            GID = new GroupId(rs.getInt("id"), rs.getString("gId"),rs.getString("day"),rs.getString("time_from"),rs.getString("time_to"));
            list.add(GID);
        }
    ...
    public void showGroupIdIdList()
    {
        ArrayList<GroupId> list = GetGroupIdList();
        DefaultTableModel model = (DefaultTableModel)tbl_gId.getModel();

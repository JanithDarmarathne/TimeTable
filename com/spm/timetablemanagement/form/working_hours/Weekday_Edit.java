 ...
 * @author Tiran Harsha
 */
public class Weekday_Edit extends javax.swing.JPanel {
    ...
    private void execute(){
        ...
        try {
            ...
            if(rs.next()){
                ...
                JOptionPane.showMessageDialog(Weekday_Edit.this, "No weekday data to show", "No data", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void btn_saveMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_saveMousePressed
        ...
        if(numOfdays == 0){
            error = true;
            JOptionPane.showMessageDialog(Weekday_Edit.this, "Select number of working days!",
        ...
        if(chk_days > numOfdays){
            error = true;
            JOptionPane.showMessageDialog(Weekday_Edit.this, "Days cannot exceed number of days : " + numOfdays,
                "Data missing",JOptionPane.ERROR_MESSAGE);
        }else if(chk_days < numOfdays){
            error = true;
            JOptionPane.showMessageDialog(Weekday_Edit.this, "Select " + (numOfdays - chk_days) + " more day(s) according to number of days" ,
                "Data missing",JOptionPane.ERROR_MESSAGE);
        }else
        error = false;
        ...
        if(rdGroup.getSelection()== null){
            error = true;
            JOptionPane.showMessageDialog(Weekday_Edit.this, "Select time slot",
                "Data missing",JOptionPane.ERROR_MESSAGE);
        }else
        error = false;
        ...
        if(checkTime()){
            error = true;
            JOptionPane.showMessageDialog(Weekday_Edit.this, "Invalide time",
                "Data missing",JOptionPane.ERROR_MESSAGE);
        }else
        error = false;
